...
// for creating RGB colors. All functions are __host__ __device__ so
...
namespace Colors {
    ...
    /// ------------------------------------------------------------------------
    __host__ __device__ inline uchar3 RGB(unsigned char r, unsigned char g, unsigned char b) {
    ...
    /// @return uchar3 RGB color.
    /// ------------------------------------------------------------------------
    __host__ __device__ inline uchar3 FromF32(float r, float g, float b) {
    ...
    /// @return uchar3 RGB color.
    /// ------------------------------------------------------------------------
    __host__ __device__ inline uchar3 FromHex(unsigned int hexRGB) {
